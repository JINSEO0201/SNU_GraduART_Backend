...
def get_order_info(request):
  try:
    ...
    final_result = {
      ...
      "payment_method": purchased_info[0]["payment_method"],
      "card_info": purchased_info[0]["card_info"],
      "price": purchased_info[0]["total_price"], ##purchased테이블에는 아이템 별로 로그가 찍히므로, total_price 말고 price같긴한데...
